...
The current [Contracts UI](https://contracts-ui.substrate.io/?rpc=ws://127.0.0.1:9944) is not updated yet to work with ink! 4.0

[ink! 4.0 project status](https://github.com/orgs/paritytech/projects/29/views/6)
